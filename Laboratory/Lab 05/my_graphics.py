...
#====================================================================
# The octagon function draws an octagon

def octagon(beginX, beginY, side, color):
    turtle.penup()                  # Raise the pen
    turtle.goto(beginX, beginY)     # Move to the starting point
    turtle.fillcolor(color)         # Set the fill color
    turtle.pendown()                # Lower the pen
    turtle.begin_fill()             # Start filling
    for count in range (8):         # Draw an octagon
        turtle.forward(side)
        turtle.left(45)
    turtle.end_fill()               # End filling
