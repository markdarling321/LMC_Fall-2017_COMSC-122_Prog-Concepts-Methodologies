...
while keep_going == 'y':
    ...
    while score < MIN_SCORE or score > MAX_SCORE:  # disallow extraneous score values
        ...
        score = int(input('\nEnter your test score: ')) # give user a chance to change an
                                                        ...
                                                        # can proceed    
    # perform the comparison to determine letter grade received
    if score >= A_SCORE:
    ...
    # give user a chance to continue using the program or not
